...
public class CretLibrarian extends JFrame {
	static CretLibrarian frame;
	...
	public CretLibrarian() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(CretLibrarian.this,"Librarian added successfully!");
				AdminPage.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(CretLibrarian.this,"Sorry, unable to save!");
			}
			}
		});
