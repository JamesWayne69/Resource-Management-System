...
public class CretTechnician extends JFrame {
	static CretTechnician frame;
	...
	public CretTechnician() {
		...
		JLabel lblAddLibrarian = new JLabel("Add Technician");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=RTechnicianDAO.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(CretTechnician.this,"Librarian added successfully!");
				AdminPage.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(CretTechnician.this,"Sorry, unable to save!");
			}
			}
		});
