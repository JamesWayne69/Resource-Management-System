...
public class AddResources extends JFrame {
	...
	public AddResources() {
		...
		JLabel lblAddBooks = new JLabel("Add Resources");
		...
		JButton btnAddBooks = new JButton("Add Resources");
		btnAddBooks.addActionListener(new ActionListener() {
			...
			int i=ResourceDao.save(callno, name, author, publisher, quantity);
			if(i>0){
