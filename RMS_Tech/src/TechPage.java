...
public class TechPage extends JFrame {
	static TechPage frame;
	...
	public TechPage() {
		...
		JLabel lblLibrarianSection = new JLabel("Resource Technician Section ");
		...
		JButton btnViewBooks = new JButton("View Stock");
		btnViewBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ViewResources.main(new String[] {});
			}
		});
		btnViewBooks.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JButton btnIssueBook = new JButton("Issue Resource");
